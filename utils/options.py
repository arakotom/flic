...
def args_parser():
    ...
    parser.add_argument('--local_rep_ep', type=int, default=1, help="the number of locl epochs for the representation for FedRep")
    ...
    parser.add_argument('--gmf', type=float, default='0', help='FedProx paarameter gmf')
